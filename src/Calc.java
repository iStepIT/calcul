...
class Calc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите 2 числа и математическую операцию в одну строку");
