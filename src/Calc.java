...
//    Output:
//            "Exa"
//1 запросить сроку scanner
//2 посчить кол-во символов 22 символов, если больше выдать "Ввели больше знаков чем нужно"
//3 считаем кол-во " и убераем все ""  готово
// 4 сплит по пробелу загоняем в массив 0 1 2 готово
// 5 сохраняем действие индекса 1 в переменую act готово
// 6 проверяем 2 индекс на число, если число и act деление или умножение
// то принтуем 0 действие 2, если - или + то выдаем ошибку что нельзя
// складывать и вычитать числа из строки
// 7 если колво ковычек = 4 то вычитаем или складываем строки

//  System.out.println(userOut(userInput));
class Calc {
